        ...
        >
          <div>
            ...
            {/* Stats row — facts a researcher could verify against
                ...
                hypothesis), source count (62 biomedical APIs wired
                today after Phase 1+2+3+4 activation), and citation-
                roundtrip rate (every cited paper is round-tripped
                through CrossRef + NCBI before landing on screen). */}
            <div
            ...
            >
              ...
              <Stat value="62" unit="sources" caption="Biomedical APIs wired" />
