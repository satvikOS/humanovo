...
class CodeInterpreterPDFGenerator:
    ...
    async def _generate_template_pdf(
        ...
        elements.append(Paragraph(
            "Generated by Humanovo 10-Stage Sequential Hypothesis Pipeline",
            subtitle_style,
        ))
        elements.append(Paragraph(
            "Claude Opus &bull; DeepSeek R1 &bull; Cohere &bull; Mistral &bull; o3-mini &bull; Kimi-K2 &bull; GPT-4.1 &bull; GPT-4o &bull; Grok &bull; Claude Opus",
        ...
        config_data = [
            ...
            ['Pipeline Architecture', '10-Stage Sequential (all models per hypothesis)'],
            ['Target Confidence', f'{target_confidence * 100:.0f}%'],
            ['Models', '10 (Claude Opus, DeepSeek, Cohere, Mistral, o3-mini, Kimi-K2, GPT-4.1, GPT-4o, Grok, Claude Opus)'],
        ...
        abstract_text = (
            ...
            f"discovery investigation for <b>{disease}</b>, conducted using Humanovo's 10-stage sequential "
            f"hypothesis pipeline. Ten distinct AI models — Claude Opus 4.6, DeepSeek-R1-0528, Cohere Command A, "
            f"Mistral-Large-3, o3-mini, Kimi-K2-Thinking, GPT-4.1, GPT-4o, Grok-4-1-fast, and Claude Opus "
            f"(Synthesizer) — work sequentially on each hypothesis through specialized stages: Seed, Expand, "
            f"Evidence, Counter, Mechanism, Validate, Ground, Score, Refine, and Finalize. The system generated "
        ...
        model_data = [
            ...
            ['1. Seed', 'Claude Opus (Bedrock)', 'Explorer', 'Generate initial hypothesis seed'],
            ['2. Expand', 'DeepSeek-R1-0528 (Azure AI)', 'Deep Reasoner', 'Causal chain reasoning'],
            ['3. Evidence', 'Cohere Command A (Azure)', 'Literature RAG', 'PubMed evidence review'],
            ['4. Counter', 'Mistral-Large-3 (Azure AI)', 'Critic', 'Counter-argument generation'],
            ['5. Mechanism', 'o3-mini (Azure OpenAI)', 'Mechanistic', 'Deep mechanistic validation'],
            ['6. Validate', 'Kimi-K2-Thinking (Azure)', 'QA Validator', 'Cross-validation'],
            ['7. Ground', 'GPT-4.1 (Azure OpenAI)', 'Grounder', 'PubMed/FDA/ClinicalTrials.gov'],
            ['8. Score', 'GPT-4o (Azure OpenAI)', 'Scorer', 'Multi-dimensional scoring'],
            ['9. Refine', 'Grok-4-1-fast (Azure AI)', 'Fast Refiner', 'Rapid refinement'],
            ['10. Finalize', 'Claude Opus (Bedrock)', 'Synthesizer', 'Final synthesis'],
        ]
        ...
        discussion_text = (
            f"The 10-stage sequential pipeline yielded a diverse set of rigorously validated hypotheses "
            f"for {disease}. Unlike parallel approaches where each model works independently, the "
            f"sequential architecture ensures every hypothesis benefits from 10 distinct analytical "
            f"perspectives: Claude Opus seeds novel hypotheses, DeepSeek-R1 expands causal chains, "
            f"Cohere reviews literature evidence (PubMed), Mistral generates counter-arguments, "
            f"o3-mini validates mechanisms, Kimi-K2 cross-validates, GPT-4.1 grounds claims against "
            f"PubMed/FDA/ClinicalTrials.gov, GPT-4o scores confidence, Grok rapidly refines, and "
            f"Claude Opus synthesizes the final result. This produces hypotheses that are maximally "
            f"strong, evidence-grounded, and non-ambiguous."
        )
