...
class PdfRenderer:
    ...
    def render(self, bundle: DocumentBundle) -> bytes:
        ...
        elements.append(Paragraph(
            "Generated by Humanovo Multi-Model AI Pipeline", subtitle_style,
        ))
        ...
        elements.append(Paragraph(
            f"Generated by Humanovo AI Discovery Platform &mdash; "
            f"{bundle.generated_at.strftime('%Y-%m-%d %H:%M UTC')} &mdash; CONFIDENTIAL",
...
class DocumentPipelineService:
    ...
    def _assemble_bundle(
        ...
        bundle = DocumentBundle(
            ...
            models_used=stats.get("models_active", []),
            external_factors=external_factors,
        )
