...
class CitationValidator:
    ...
    async def validate_and_collect_citations(
        ...
        queries = [
            ...
            "multi-model AI drug discovery",
            "large language models biomedical research",
        ]
...
''')
        ...
        h.append('Generated by <strong>Humanovo</strong> &mdash; FDA/R&amp;D-Grade AI Discovery Platform<br/>')
