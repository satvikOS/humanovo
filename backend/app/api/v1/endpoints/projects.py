...
# `/{project_id}/hypotheses` lives in jamison_api.py — richer payload
# (scores, versions, pipeline trace). We previously also mounted a
# slimmer duplicate here; removed to fix the double-registration the
# router-contract test caught. If you need the lean shape, add a
# ?shape=slim param to the jamison handler instead of reintroducing a
# competing route.
