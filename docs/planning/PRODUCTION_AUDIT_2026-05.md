...
| P0 | Investor / strategy materials in repo | `Speedrun.zip`, `humanovo for Speedrun.pdf`, `docs/planning/Project Jamison.md`, `docs/planning/Cormorant_Garamond.zip`, `docs/planning/files.zip`, `docs/planning/files (1).zip`, `docs/planning/COMPETITIVE_POSITIONING.md`, `docs/planning/BENCHMARK_POSITIONING.md` |
...
- D2-D3: History rewrite — remove `prompts.py`, `Speedrun.zip`, `humanovo for Speedrun.pdf`, `.terraform-outputs-dev.json`, `docs/planning/Project Jamison.md`, `docs/planning/Cormorant_Garamond.zip`, `docs/planning/files.zip`, `docs/planning/files (1).zip`, `docs/planning/COMPETITIVE_POSITIONING.md`, `docs/planning/BENCHMARK_POSITIONING.md` from full git history.
