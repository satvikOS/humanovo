# GenUp Production Environment Configuration
...
domain_name         = ""  # e.g., "genup.example.com"
...
# API Gateway
cors_allowed_origins = ["https://genup.example.com"]  # Restrict in production
enable_jwt_auth      = true
jwt_issuer           = ""  # e.g., "https://auth.example.com"
jwt_audience         = []  # e.g., ["genup-api"]
...
opensearch_collection_name = "genup-vectors"
