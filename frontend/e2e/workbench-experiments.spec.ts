...
// /workbench and /experiment-tracker are short-circuited to /dashboard
// by the V1Gate in App.tsx (isHiddenInV1). Re-enable when
// VITE_V1_HIDDEN_ROUTES_ENABLED=true ships in v1.1.
